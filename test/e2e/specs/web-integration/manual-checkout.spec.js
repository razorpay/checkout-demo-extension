...
describe('Home Screen', () => {
  ...
  describe('Payment tabs should be shown based on passed payment options', () => {
    ...
    it('Hide card tab, if `card` is false', () => {
      ...
      assert.isNotOk($('#payment-options > [tab=card]'), 'Card tab is hidden');
    });
    ...
    it('Hide Wallet, if `wallet` is set to false', () => {
      ...
      assert.isNotOk($('#payment-options > [tab=wallet]'), 'Wallet is hidden');
      ...
      assert.isOk($('#payment-options > [tab=card]'), 'Only Card tab is shown');
    });
  });

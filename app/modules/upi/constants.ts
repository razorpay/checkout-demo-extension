...
// The list is updated time to time based on this link https://www.npci.org.in/what-we-do/upi/3rd-party-apps.
// In Future, we have to fetch the list from the backend api's
...
// This list is hardcoded in sync with api repo's app/Gateway/Upi/Base/ProviderCode.php $pspForAutopay variable
export const suggestionVPAForRecurring = [
  'upi',
  'paytm',
  'ibl',
  'ybl',

export default (foregroundColor, backgroundColor) =>
  `<svg width="25" height="23" viewBox="0 0 25 23" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fill="${backgroundColor}" d="M7.326 5L16 2.11V5h2V2.11A2 2 0 0 0 15.368.211L1 5h6.326zM15 12v4h8v-4h-8zm0-2h8a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-8a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2z"/>
  </svg>`;

...
(function(){
  ...
  */
  Razorpay.payment = {
    authorize: function(request, throwError){
      Razorpay(request.options).authorize(request, throwError)
    }
  }
  proto.authorize = function(request, throwError){
  ...
  proto.getPaymentMethods = function(callback){
    return $.ajax({
  ...
  */
  proto.validate = function(data, throwError){
    var errors = [];

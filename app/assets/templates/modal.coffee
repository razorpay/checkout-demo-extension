...
<div class="rzp-container">
    <div class = "rzp-modal ow-closed" id = "{{id}}">
        <div class = "rzp-header">
        	...
        	<div class = "rzp-clear"></div>
        </div>
        <div class="rzp-tabs-container">
            {{#if netbanking}}
            <ul class="rzp-tabs">
                <li><a href="#rzp-tabs-cc">Card</a></li>
                <li><a href="#rzp-tabs-nb">Net Banking</a></li>
            </ul>
            {{/if}}
            <div id="rzp-tabs-cc">
                <form class = "rzp-body" method = "POST">
            ...
            {{#if netbanking}}
                <div id="rzp-tabs-nb" class="rzp-padder-top">
                    <form class = "rzp-body" method = "POST">
                    <input type = "hidden" name = "amount" value = "{{amount}}">
                    <input type = "hidden" name = "currency" value = "INR">
                    {{#each udf}}

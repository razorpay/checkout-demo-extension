      ...
      localStorage.setItem(
        'rzp_preffered_instruments',
        {
          ...
          Netbanking:
            '{"' +
            hashKey +
            '":[{"bank":"HDFC","method":"netbanking","timestamp":1574062745851,"success":true,"frequency":2,"id":"Dhh86QTueOpyWX"}],"4c184683":[{"bank":"HDFC","method":"netbanking","timestamp":1574072395307,"success":true,"frequency":1,"id":"DhlUS88dTUwBC5"}]}',
          QR:
            '{"' +
            hashKey +
            '":[{"_[flow]":"intent","_[upiqr]":"1","method":"upi","timestamp":1574079022916,"success":true,"frequency":2,"id":"DhnN8SggG8Ihdy"}]}',
          Card:
            '{"' +
            hashKey +
            '": [{"method": "card","token_id": "token_9AT28Pxxe0Npi9","type": "credit","issuer": "ICIC","network": "Visa","timestamp": 1574056926308,"success": true,"frequency": 1,"id": "Dhh671dR688OWQ"}]}',
          Wallet:
            '{"' +
            hashKey +
